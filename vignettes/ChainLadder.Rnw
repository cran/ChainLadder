...
\item \emph{Computational Actuarial Science with R}~\cite{gesmann2014claims}

\item \emph{Modern Actuarial Risk Theory -- Using R}~\cite{KaassGoovaertsDhaeneDenuit2001}
